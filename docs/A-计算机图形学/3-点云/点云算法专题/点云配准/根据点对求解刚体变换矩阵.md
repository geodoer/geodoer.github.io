...
### Eigen代码
完整代码：[cgal-examples/solve_transform_matrix.cpp](https://github.com/geodoer/cgal-examples/blob/main/examples/Solvers/solve_transform_matrix.cpp)
...
4. [Eigen 矩阵的SVD分解](https://blog.csdn.net/qq_39400324/article/details/123604126)
